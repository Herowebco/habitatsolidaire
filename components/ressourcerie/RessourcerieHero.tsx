        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-anthracite/75 text-lg font-manrope leading-relaxed mb-8 max-w-md">
              Un espace dédié à la réception, au tri et à la redistribution à moindre coût
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                <IdCard size={15} className="text-terracotta shrink-0" />
                <span className="font-semibold">Carte d'adhésion 20€/an</span>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative rounded-3xl overflow-hidden aspect-[4/5] max-h-[340px] md:max-h-[500px] shadow-2xl">
              <Image
                src="/ressourcerie-masny.jpg"
                alt="La Ressourcerie solidaire à Masny"
                fill
